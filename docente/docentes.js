const docentes = {
    ...
    methods: {
        ...
        modificarDocente(docente) {
            ...
            this.docente.usuarioId = docente.usuarioId || null;
        },
        ...
        async guardarDocente() {
            let datos = {
                ...
                usuarioId: this.docente.usuarioId
            };
                ...
                <div class="card border-0 shadow-sm bg-body-tertiary" style="max-width: 480px;">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4 text-center">
                            <div class="position-relative d-inline-block">
                                ...
                                <label class="position-absolute bottom-0 end-0 bg-body border rounded-circle p-1 shadow-sm"
                                    ...
                                    <i class="bi bi-camera-fill text-success small"></i>
                        ...
                        <div class="mb-3 row align-items-center">
                            <label class="col-sm-5 col-form-label text-body-secondary small fw-bold text-uppercase text-nowrap">Código</label>
                            <div class="col-sm-5">
                                <input placeholder="Ej. D-001" required v-model="docente.codigo" type="text" class="form-control form-control-sm bg-transparent">
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                            <label class="col-sm-5 col-form-label text-body-secondary small fw-bold text-uppercase text-nowrap">Nombre Completo</label>
                            <div class="col-sm-7">
                                <input placeholder="Nombre completo" required v-model="docente.nombre" type="text" 
                                       class="form-control form-control-sm"
                                       :class="docente.usuarioId ? 'bg-body-secondary' : 'bg-transparent'"
                                       :readonly="docente.usuarioId">
                                <div v-if="docente.usuarioId" class="text-muted mt-1" style="font-size: 0.65rem;">
                                    <i class="bi bi-info-circle me-1"></i>Sincronizado con la cuenta de usuario.
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                            <label class="col-sm-5 col-form-label text-body-secondary small fw-bold text-uppercase text-nowrap">Dirección</label>
                            <div class="col-sm-7">
                        ...
                        <div class="mb-3 row align-items-center">
                            <label class="col-sm-5 col-form-label text-body-secondary small fw-bold text-uppercase text-nowrap">Email Institucional</label>
                            <div class="col-sm-7">
                        ...
                        <div class="mb-3 row align-items-center">
                            <label class="col-sm-5 col-form-label text-body-secondary small fw-bold text-uppercase text-nowrap">Teléfono</label>
                            <div class="col-sm-6">
                        ...
                        <div class="mb-3 row align-items-center">
                            <label class="col-sm-5 col-form-label text-body-secondary small fw-bold text-uppercase text-nowrap">Fecha Nacimiento</label>
                            <div class="col-sm-6">
                                <input required v-model="docente.fechaNacimiento" type="date" class="form-control form-control-sm bg-transparent">
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                            <label class="col-sm-5 col-form-label text-body-secondary small fw-bold text-uppercase text-nowrap">Género</label>
                            <div class="col-sm-6">
                        ...
                        <div class="mb-3 row align-items-center">
                            <label class="col-sm-5 col-form-label text-body-secondary small fw-bold text-uppercase text-nowrap">Número de DUI</label>
                            <div class="col-sm-6">
                        ...
                        <div class="mb-1 row align-items-center">
                            <label class="col-sm-5 col-form-label text-body-secondary small fw-bold text-uppercase text-nowrap">Escalafón</label>
                            <div class="col-sm-6">
